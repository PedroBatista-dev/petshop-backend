...
export class CreateTablesInit1751550842446 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "contatos" ADD CONSTRAINT "FK_78488283edbb7eee6a4f45412f8" FOREIGN KEY ("idEmpresa") REFERENCES "empresas"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "contatos" ADD CONSTRAINT "FK_2d58d87ae17d8baf13e1bfe349d" FOREIGN KEY ("idUsuario") REFERENCES "usuarios"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "enderecos" ADD CONSTRAINT "FK_d9be28a4a1886fb93f5392c7c57" FOREIGN KEY ("idPais") REFERENCES "paises"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "enderecos" ADD CONSTRAINT "FK_71238b24667fc8b806b4bedcf10" FOREIGN KEY ("idMunicipio") REFERENCES "municipios"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "enderecos" ADD CONSTRAINT "FK_72b762c790a9ac9b8f3b2dba801" FOREIGN KEY ("idEmpresa") REFERENCES "empresas"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "enderecos" ADD CONSTRAINT "FK_669782fbb62f3fa87290046f39a" FOREIGN KEY ("idUsuario") REFERENCES "usuarios"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "usuarios" ADD CONSTRAINT "FK_f73296da306a1e18b8d9c96b68b" FOREIGN KEY ("idCargo") REFERENCES "cargos"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "usuarios" ADD CONSTRAINT "FK_3e2f00038c8cf462acbcf774b6b" FOREIGN KEY ("idEmpresa") REFERENCES "empresas"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        
        const adminId = uuidv4();
        const clienteId = uuidv4();

        await queryRunner.query(`
            INSERT INTO "cargos" ("id", "descricao", "canBeDeleted", "createdAt", "updatedAt")
